...
const roles = [
    { title: "E-commerce Analyst", image: ECommerceAnalyst },
    { title: "E-commerce Business Development Manager", image: ECommerceBusinessDevManager },
...
const ECommerceMgm = () => {
    return (
        <div className="container">
            ...
            <h3 className="ecomsubtitle">Click below to explore any of the following career(s)</h3>
