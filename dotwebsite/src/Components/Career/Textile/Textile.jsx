    ...
    <div className="lawcontainer">
      ...
      <p className="lawdescription">
       The textile and clothing industry is a vital part of the global economy, 
        involving the design, production, and distribution of textiles and apparel. 
        Careers in this industry range from designing fabrics to managing sales and 
        ensuring quality control. Professionals in this field work on innovations in 
        fabric technology, sustainable fashion, and efficient manufacturing processes. 
        Whether you are interested in creative design, production, or retail management, 
        the textile industry offers diverse career paths with opportunities to influence 
        fashion trends and contribute to global markets.
      </p>
