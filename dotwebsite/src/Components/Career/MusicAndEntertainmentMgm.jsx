...
const roles = [
    { title: "Sound Technician", image: SoundTechnician, link: "https://en.wikipedia.org/wiki/Sound_technician" },
    { title: "Staff Publicist", image: StaffPublicist, link: "https://en.wikipedia.org/wiki/Publicist" },
    { title: "Stage Manager", image: StageManager, link: "https://en.wikipedia.org/wiki/Stage_manager" },
    { title: "Studio Manager", image: StudioManager, link: "https://en.wikipedia.org/wiki/Studio_manager" },  // This might need to be checked, as it's less common
    { title: "Tour Manager", image: TourManager, link: "https://en.wikipedia.org/wiki/Tour_manager_(music)" },
    { title: "Audio Engineer", image: AudioEngineer, link: "https://en.wikipedia.org/wiki/Audio_engineer" },
    { title: "Concert Promoter", image: ConcertPromoter, link: "https://en.wikipedia.org/wiki/Concert_promoter" },
    { title: "Music Producer", image: MusicProducer, link: "https://en.wikipedia.org/wiki/Record_producer" },
