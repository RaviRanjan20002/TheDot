...
const roles = [
    ...
    // { title: "Party Planner", image: PartyPlanner },
    {
                title: "& many more",
                image: manymore,
                link: "https://www.google.com/search?q=Event+Management+Careers&sca_esv=664f7e6c30f8a07c&rlz=1C1VDKB_enIN1133IN1133&sxsrf=AHTn8zopozgaIwomedQAOQiuGyjxK_5HHw%3A1738733782418&ei=1viiZ6L-GKa02roP3YCByAI&ved=0ahUKEwiiwdaL6KuLAxUmmlYBHV1AACkQ4dUDCBA&uact=5&oq=Event+Management+Careers&gs_lp=Egxnd3Mtd2l6LXNlcnAiGEV2ZW50IE1hbmFnZW1lbnQgQ2FyZWVyczILEAAYgAQYkQIYigUyBhAAGBYYHjIGEAAYFhgeMgYQABgWGB4yBhAAGBYYHjIGEAAYFhgeMgYQABgWGB4yBhAAGBYYHjIGEAAYFhgeMgYQABgWGB5IxwRQAFgAcAB4AZABAJgB3wGgAd8BqgEDMi0xuAEDyAEA-AEC-AEBmAIBoALoAZgDAJIHAzItMaAH3QY&sclient=gws-wiz-serp&jbr=sep:0"
            },
];
...
const EventManagementMgm = () => {
    return (
        <div className="container">
            ...
            <h3 className="eventsubtitle">Click below to explore any of the following career(s)</h3>
